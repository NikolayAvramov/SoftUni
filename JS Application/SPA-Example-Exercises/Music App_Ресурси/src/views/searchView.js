...
import {getById} from "../api/service.js";
const searchTemplate = (user, album) => html`<section id="searchPage">
	...
	<div class="search-result">
		...
		<div class="card-box">
			...
			<div>
				...
				<div class="btn-group">
					${user
						? html`<a href="/data/albums/${album._id}" id="details"
								>Details</a
						  >`
						: ""}
				</div>
...
export async function showSearch(ctx) {
	...
	ctx.render(searchTemplate(ctx.user, album));
}
